  ...
  //alice carousel = parameters
      ...
      return (
        ...
        >
          ...
          <img src={image_001}
            onDragStart={handleOnDragStart} className="Gallery001" alt='img1'/>
          <img src={image_002}
            onDragStart={handleOnDragStart} className="Gallery001" alt='img2'/>
          <img src={image_003}
            onDragStart={handleOnDragStart} className="Gallery001" alt='img3'/>
          <img src={image_004}
            onDragStart={handleOnDragStart} className="Gallery001" alt='img4'/>
